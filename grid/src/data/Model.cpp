...
//
//
// zar::Model::Model(const char*& path)
// {
//     _name = path;
//
...
// }
//
// void zar::Model::render(GLShader* shader)
// {
...
// }
//
// bool zar::Model::has_materials() const
// {
//     return !_materials.empty();
// }
//
// void zar::Model::parse_node_data(const aiScene* ai_scene, aiNode* ai_node)
// {
...
// }
//
// void zar::Model::parse_mesh_data(aiMesh* ai_mesh)
// {
//     Vertices vertices;
//     Indices indices;
//
...
//         // positions
//         
//         vertex.position = util::assimp_helper::toVec3(ai_mesh->mVertices[i]);
//
//         // normals
...
// }
//
// const zar::Texture& zar::Model::parse_texture(aiMaterial* ai_material, aiTextureType type, const char* directory)
// {
//     return {};
// }
//
// void zar::Model::parse_materials(const aiScene* ai_scene, const char* directory)
// {
// }
